...
class LoteProductoBase(BaseModel):
    producto_textil_id: UUID4
    proveedor_id: Optional[UUID4] = Field(None, description="ID del proveedor")
    ...
    responsable_evaluacion_id: Optional[UUID4] = Field(None, description="ID del responsable de evaluación")
...
class LoteProductoUpdate(BaseModel):
    ...
    responsable_evaluacion_id: Optional[UUID4] = None
...
class RecepcionCompraBase(BaseModel):
    orden_compra_id: UUID4
    lote_producto_id: UUID4
    responsable_recepcion_id: UUID4
    ...
    responsable_revision_id: Optional[UUID4] = Field(None, description="ID del responsable de revisión")
    ...
    responsable_aprobacion_id: Optional[UUID4] = Field(None, description="ID del responsable de aprobación")
...
class RecepcionCompraUpdate(BaseModel):
    ...
    responsable_revision_id: Optional[UUID4] = None
    ...
    responsable_aprobacion_id: Optional[UUID4] = None
    comentarios: Optional[str] = None
...
class BusquedaProductoTextil(BaseModel):
    ...
    almacen_id: Optional[UUID4] = Field(None, description="ID del almacén")
    empresa_id: Optional[UUID4] = Field(None, description="ID de la empresa (para búsquedas multiempresa)")
...
class ResultadoBusquedaAvanzada(BaseModel):
    ...
    almacen_solicitud: Optional[UUID4] = None
...
class EtiquetaProductoBase(BaseModel):
    ...
    responsable_impresion_id: Optional[UUID4] = Field(None, description="ID del responsable de impresión")
...
class EtiquetaProductoUpdate(BaseModel):
    ...
    responsable_impresion_id: Optional[UUID4] = None
    activa: Optional[bool] = None
